...
import { createChampionship } from '@/lib/database'
...
export default function CreateChampionshipPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!user) {
      toast.error('You must be logged in to create a championship')
      return
    }
    ...
    try {
      // Convert dd/mm/yyyy format to YYYY-MM-DD format for database
      ...
      console.log('Submitting championship data:', championshipData)

      const result = await createChampionship(championshipData)
      ...
      let errorMessage = 'Failed to create championship. Please try again.'
    ...
    <div className="min-h-screen bg-black">
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-3xl mx-auto">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-white mb-2">Create Championship</h1>
            <p className="text-gray-400">
              Share tournament information with the esports community
            </p>
          </div>
          ...
          <Card className="bg-gray-800 border-gray-700">
            <CardHeader>
              ...
              <CardDescription className="text-gray-400">
                Fill in the information about your tournament
              </CardDescription>
            </CardHeader>
            <CardContent>
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) => {
                        ...
                        // Auto-add slashes after 2 and 4 digits
                        if (value.length > 0) {
